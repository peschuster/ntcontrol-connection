...
test('INPUT SELECT specification', () => {
    ...
    expect(cmd.getSetCommand(ProjectorInput.HDMI2)).toBe('IIS:HD2')
    expect(cmd.getSetCommand(ProjectorInput.HDMI3)).toBe('IIS:HD3')
    expect(cmd.getSetCommand(ProjectorInput['NETWORK/USB'])).toBe('IIS:NWP')
    expect(cmd.getSetCommand(ProjectorInput['Panasonic Application'])).toBe('IIS:PA1')
    expect(cmd.getSetCommand(ProjectorInput['Miracast/Mirroring'])).toBe('IIS:MC1')
    expect(cmd.getSetCommand(ProjectorInput['MEMORY VIEWER'])).toBe('IIS:MV1')
    ...
    expect(cmd.parseResponse('HD2')).toBe(ProjectorInput.HDMI2)
    expect(cmd.parseResponse('HD3')).toBe(ProjectorInput.HDMI3)
    expect(cmd.parseResponse('NWP')).toBe(ProjectorInput['NETWORK/USB'])
    expect(cmd.parseResponse('PA1')).toBe(ProjectorInput['Panasonic Application'])
    expect(cmd.parseResponse('MC1')).toBe(ProjectorInput['Miracast/Mirroring'])
    expect(cmd.parseResponse('MV1')).toBe(ProjectorInput['MEMORY VIEWER'])
...
test('PICTURE MODE specification', () => {
    ...
    expect(cmd.getSetCommand(PictureMode['BLACK BOARD'])).toBe('VPM:BBD')
    expect(cmd.getSetCommand(PictureMode['WHITE BOARD'])).toBe('VPM:WBD')
    ...
    expect(cmd.parseResponse('BBD')).toBe(PictureMode['BLACK BOARD'])
    expect(cmd.parseResponse('WBD')).toBe(PictureMode['WHITE BOARD'])
...
test('COLOR TEMPERATURE specification', () => {
    ...
    // Set
    expect(cmd.getSetCommand(ColorTemperature.LOW)).toBe('OTE:0')
    expect(cmd.getSetCommand(ColorTemperature.DEFAULT)).toBe('OTE:1')
    expect(cmd.getSetCommand(ColorTemperature.HIGH)).toBe('OTE:2')
    ...
    // Parse
    expect(cmd.parseResponse('0')).toBe(ColorTemperature.LOW)
    expect(cmd.parseResponse('1')).toBe(ColorTemperature.DEFAULT)
    expect(cmd.parseResponse('2')).toBe(ColorTemperature.HIGH)
...
test('TEST PATTERN specification', () => {
    ...
    expect(cmd.getSetCommand(TestPattern['10%-Luminance'])).toBe('OTS:25')
    ...
    expect(cmd.parseResponse('25')).toBe(TestPattern['10%-Luminance'])
